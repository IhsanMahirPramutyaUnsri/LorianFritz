    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">Save books you love by clicking the heart icon on any book card.</p>
          <Link
            to="/"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map(book => {
            ...
            return (
              <div key={book.id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                ...
                <div className="p-4 flex flex-col flex-1">
                  <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-blue-50 dark:bg-blue-900/40 self-start mb-2" style={{ color: '#0A2342' }}>{book.genre}</span>
                  <Link to={`/books/${book.id}`} className="no-underline">
                  ...
                  <div className="flex items-center gap-1 mb-3">
                    ...
                    <span className="text-gray-400 dark:text-gray-500 text-xs">{book.rating}</span>
                  </div>
                  <div className="mt-auto flex items-center justify-between gap-2">
                    <div className="flex flex-col">
                      {hasDiscount ? (
                        <>
                          ...
                          <span className="font-bold text-sm text-red-600">{formatPrice(discountedPrice)}</span>
                        </>
                      ) : (
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center rounded-full border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                      ...
                      <button
                        onClick={() => { addToCart({ ...book, price: discountedPrice }); addToast(`"${book.title}" added to cart`); }}
